...
// Canvas 2D con mezcla aditiva y sprites de brillo precalculados (sin dependencias).

type Props = {
  className?: string;
  /** Número de partículas de la esfera (se reduce automáticamente en móviles). */
  particles?: number;
  /** Render estático de alta calidad (para exportar imágenes). */
  still?: boolean;
...
export function PulseSphere({ className = "", particles = 3600, still = false, time = 2.1 }: Props) {
